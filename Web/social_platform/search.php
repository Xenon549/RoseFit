...
$sql = "SELECT DISTINCT * FROM community_article where article_content LIKE '%$content%' ORDER BY article_id DESC";
    ...
    <div class="dark-wrapper">
      <div class="container inner">
        <div class="hero text-center">
          <p>搜尋"<?php echo $content;?>"的結果<br class="hidden-xs hidden-sm" />
        ...
        echo "<ul>"; 
        if($page > 1){
          echo "<li><a class=\"btn btn-square btn-icon\"href=\"http://120.110.113.70/rosefit_greenhouse/social_platform/search.php?page=".$pre."&search=".$content."\"><i class=\"ion-android-arrow-back\"></i></a></li>";
          if($page > 3){
          echo "<li><a class=\"btn btn-square btn-icon\" href=\"http://120.110.113.70/rosefit_greenhouse/social_platform/search.php?page=1\"><span>1</span></a></li>";
        ...
        if($pages <= $pageNum){
          for($i=$start;$i<=$pages;$i++){
            if($i==$page){
              echo "<li class=\"active\"><a class=\"btn btn-square\" href=\"http://120.110.113.70/rosefit_greenhouse/social_platform/search.php?page=".$i."&search=".$content."\"<span>".$i."</span></a></li>";
            }
            else{
              //if($page > 3){
              echo "<li><a class=\"btn btn-square\" href=\"http://120.110.113.70/rosefit_greenhouse/social_platform/search.php?page=".$i."&search=".$content."\"><span>".$i."</span></a></li>";
              //}
            }
          }
        }
        ...
        if($page < $pages){
          if($page < $pages-2){
          echo "<li><a class=\"btn btn-square btn-icon\"<span style='background: #fff0 !important;'>...</span></a></li>";  
          echo "<li><a class=\"btn btn-square btn-icon\" href=\"http://120.110.113.70/rosefit_greenhouse/social_platform/search.php?page=".$pages."&search=".$content."\"><span>".$pages."</span></a></li>";
          }
          echo "<li><a class=\"btn btn-square btn-icon\"href=\"http://120.110.113.70/rosefit_greenhouse/social_platform/search.php?page=".$next."&search=".$content."\"><i class=\"ion-android-arrow-forward\"></i></a></li>";
        }
        echo "</ul>";        
        ?>
<!--
