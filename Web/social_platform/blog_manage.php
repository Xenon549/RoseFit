    ...
    <div class="dark-wrapper">
      <div class="container inner">
        ...
        <div class="hero text-center">
          <h2>文章管理</h2><br/>
          <!--
          <a class="btn btn-forest" style="padding-top: 13px;" data-toggle="modal" data-target="#myModal2">新增文章</a>
          -->
          <a class="btn btn-forest" style="padding-top: 13px;" href="./blog_new.php">新增文章</a>
        </div>
        ...
        <div class="tiles">
          <div class="items row row-offset-0">
            <div class="item col-xs-6 col-sm-6 col-md-4">
              <figure class="overlay"> <a href="./blog_edit.php?id=<?=$article[0]?>">
            ...
            <!--/column -->
            <div class="item col-xs-6 col-sm-6 col-md-4">
              <figure class="overlay"> <a href="./blog_edit.php">
                <div class="text-overlay caption">
                  <div class="info">
        ...
        <!-- /.tiles -->
        <div class="modal inverse-wrapper modal-transparent move-from-top" id="myModal1" tabindex="-1" role="dialog" style="background-image: url(img/rose5.jpg);" data-backdrop="static" data-keyboard="false">
          <script>
          </script>

          <div class="modal-dialog modal-lg" role="document">
            <h2 class="post-title text-center color">文章管理</h2>
              ...
              <form action="editarticle.php" method="post" class="vanilla vanilla-form" novalidate="novalidate">
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    ...
                    -->
                    <input type="file" class="form-control" style="margin-top:10px;margin-bottom:-14px; background-color: #e1e5e6!important; border-color: #e1e5e6!important; " type="file" name="img" multiple><br/>
                    ...
                    <div align="right">
                      ...
                      <a class="btn btn-blue" style="display:inline; padding-top: 13px;" onclick="myFunction();">放棄編輯</a>
                      ...
                      <a type="submit" class="btn btn-blue" style="display:inline;padding-top: 13px; " onclick="myFunction2();">刪除本文</a>
                      <script type="text/javascript">
                        function myFunction2(){
                          var msg=confirm("確定刪除本文?");
                          if(msg==true){
                            window.location.replace("./blog_manage.php");
                          }else{
                            return false;
        ...
        <div class="modal inverse-wrapper modal-transparent move-from-top" id="myModal2" tabindex="-1" role="dialog" style="background-image: url(img/rose5.jpg);" data-backdrop="static" data-keyboard="false">
          <script>
          </script>
              ...
              <form action="editarticle.php" method="post" class="vanilla vanilla-form" novalidate="novalidate">
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    ...
                    <input type="text" value="標籤<?php echo $tag[1];?>" data-role="tagsinput" name="tag" style="display:inline;">
                    <br/><br/>
                    <!--/.radio-set -->
                    <div align="right">
                      <input type="submit"  value="儲存編輯" data-error="錯誤" data-processing="儲存中.." data-success="已儲存" class="btn btn-blue" style="display:inline" > 
