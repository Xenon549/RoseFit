...
$sql = "SELECT DISTINCT * FROM community_article where catalog_id = 'prince' ORDER BY article_id DESC";
    ...
    <div class="dark-wrapper">
      <div class="container inner">
        <div class="hero text-center">
          <p>小王子星球<br class="hidden-xs hidden-sm" />
        ...
        <div class="tiles blog">
          ...
          echo   '<figure class="overlay"> <a href="#">';
