...
<?php include 'inc/config.php'; $template['header_link'] = 'UI LAYOUTS'; $template['header'] = ''; $template['layout'] = 'fixed-width'; ?>
        ...
        <div class="col-sm-6 col-lg-4">
            ...
            <a href="page_ready_profile.php" class="widget">
                ...
                <div class="widget-content border-bottom text-center themed-background-muted">
                    ...
                    <h2 class="widget-heading h3 text-dark" ><?php echo $row[1]?></h2>
