    ...
    <div class="block animation-fadeInQuickInv">
        ...
        <div class="block-title">
            <div class="block-options pull-right">
                <a href="http://120.110.113.70/rosefit_greenhouse/social_platform/page_ready_login.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="Back to login"><i class="fa fa-user"></i></a>
            </div>
            <h2>Register</h2>
        </div>
        <!-- END Register Title -->
        ...
        <!-- Register Form -->
        <form id="form-register" action="page1_finish_register.php" method="post" class="form-horizontal">
