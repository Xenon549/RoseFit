    ...
    <div class="block animation-fadeInQuickInv">
        ...
        <div class="block-title">
            <div class="block-options pull-right">
                <a href="page_ready_register.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="回上一頁"><i class="fa fa-long-arrow-left"></i></a>
            </div>
            <h2>使用設定</h2>
        </div>
        <!-- END Register Title -->
        ...
        <form id="form-register" action="page_finish_register2.php" method="post" class="form-horizontal">
            <div class="form-group">
                <div class="col-xs-12">
                    ...
                    <p id="note">一般使用者，將享有全自動溫室控制服務。</p>
                    <script type="text/javascript">
                        function separate_function(){
                            var x = document.getElementById("separate").value;
                            if (x == "expert") {
                                document.getElementById("note").innerHTML = "我們將會由信箱連絡您，確認專家身分。";
                            }
                        }
                    </script>
                </div>
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <input type="text" id="register-greenhousename" name="register-greenhousename" class="form-control" placeholder="幫溫室取的名字吧!">
                </div>
            </div>
            <div class="form-group">
                <div class="col-xs-12">
                    <input type="text" id="register-key" name="register-key" class="form-control" placeholder="溫室金鑰輸入">
                </div>
            </div>
            ...
            <div class="form-group form-actions">
                ...
                <div class="col-xs-6 text-right">
                    <button type="submit" class="btn btn-effect-ripple btn-success"><i class="fa fa-plus"></i> 建立會員</button>
                </div>
            </div>
